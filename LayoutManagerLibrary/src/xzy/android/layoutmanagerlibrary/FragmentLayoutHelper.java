...
/**
 * @author zhengyangxu
 * @date Nov 5, 2014 9:38:36 PM TODO
 */
public class FragmentLayoutHelper extends LayoutStateHelper {

    private ViewGroup mContentView;

    public FragmentLayoutHelper(Context context) {
        mContext = context;
        mContentView = (ViewGroup) LayoutInflater.from(mContext).inflate(
                R.layout.fragment_layout_helper_content, null);
    }
